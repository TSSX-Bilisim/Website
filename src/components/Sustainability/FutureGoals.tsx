                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div className="content-box">
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <h3 className="text-xl font-semibold text-neutral-800 break-keep">
                                    {t("page.sections.future.performance.title")}
                                </h3>
                            </div>
                            <ul className="space-y-4">
                                {(t("page.sections.future.performance.items", { returnObjects: true }) as string[]).map((item, index) => (
                        ...
                        <div className="content-box">
                            <div className="flex items-center gap-3 mb-5">
                                ...
                                <h3 className="text-xl font-semibold text-neutral-800 break-keep">
                                    {t("page.sections.future.impact.title")}
                                </h3>
                            </div>
                            <ul className="space-y-4">
                                {(t("page.sections.future.impact.items", { returnObjects: true }) as string[]).map((item, index) => (
                                    <li key={index} className="flex items-start gap-3">
